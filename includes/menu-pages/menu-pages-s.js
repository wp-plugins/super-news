		...
		if (location.href.match (/page\=ws-plugin--super-news-search/))
			{
				...
				/**/
				customInjection = '<?php echo c_ws_plugin__super_news_utils_strings::esc_js_sq (trim ($GLOBALS["WS_PLUGIN__"]["super_news"]["o"]["custom_injection"])); ?>';
				thumbProvider = '<?php echo c_ws_plugin__super_news_utils_strings::esc_js_sq ($GLOBALS["WS_PLUGIN__"]["super_news"]["o"]["thumb_provider"]); ?>';
				/**/
				thumbProvider = (thumbProvider === 'shrinktheweb') ? 'http://images.shrinktheweb.com/xino.php?embed=1&stwaccesskeyid=<?php echo c_ws_plugin__super_news_utils_strings::esc_js_sq (urlencode ($GLOBALS["WS_PLUGIN__"]["super_news"]["o"]["thumb_key"])); ?>&stwsize=lg&stwurl=' : thumbProvider;
				thumbProvider = (thumbProvider === 'websnapr') ? 'http://images.websnapr.com/?size=S&key=<?php echo c_ws_plugin__super_news_utils_strings::esc_js_sq (urlencode ($GLOBALS["WS_PLUGIN__"]["super_news"]["o"]["thumb_key"])); ?>&url=' : thumbProvider;
