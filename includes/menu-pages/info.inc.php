...
echo '<h2><div>Developed by <a href="' . esc_attr (c_ws_plugin__super_news_readmes::parse_readme_value ("Plugin URI")) . '" target="_blank"><img src="' . esc_attr ($GLOBALS["WS_PLUGIN__"]["super_news"]["c"]["dir_url"]) . '/images/brand-light.png" alt="." /></a></div>Super News Information</h2>' . "\n";
/**/
...
/**/
echo '<a href="' . esc_attr (add_query_arg ("c_check_ver", urlencode (c_ws_plugin__super_news_readmes::parse_readme_value ("Version")), c_ws_plugin__super_news_readmes::parse_readme_value ("Plugin URI"))) . '" target="_blank"><img src="' . esc_attr ($GLOBALS["WS_PLUGIN__"]["super_news"]["c"]["dir_url"]) . '/images/brand-updates.png" class="ws-menu-page-brand-updates" alt="." /></a>' . "\n";
/**/
...
if (apply_filters ("ws_plugin__super_news_during_info_page_during_left_sections_display_readme", true, get_defined_vars ()))
	{
		...
		echo c_ws_plugin__super_news_readmes::parse_readme () . "\n";
		echo '</div>' . "\n";
		/**/
