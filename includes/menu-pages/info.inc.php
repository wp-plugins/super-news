...
/**/
echo '<a href="' . ws_plugin__super_news_parse_readme_value ("Plugin URI") . '?c_check_ver=' . urlencode (ws_plugin__super_news_parse_readme_value ("Version")) . '" target="_blank"><img src="' . $GLOBALS["WS_PLUGIN__"]["super_news"]["c"]["dir_url"] . '/images/brand-updates.png" class="ws-menu-page-brand-updates" alt="." /></a>' . "\n";
/**/
