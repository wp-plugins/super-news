...
echo '<h2><div>Developed by <a href="' . ws_plugin__super_news_parse_readme_value ("Plugin URI") . '" target="_blank"><img src="' . $GLOBALS["WS_PLUGIN__"]["super_news"]["c"]["dir_url"] . '/images/brand-light.png" alt="." /></a></div>Super News</h2>' . "\n";
/**/
		...
		if (apply_filters ("ws_plugin__super_news_during_search_page_during_left_sections_display_search", true, get_defined_vars ()))
			{
				...
				echo '<img src="' . $GLOBALS["WS_PLUGIN__"]["super_news"]["c"]["dir_url"] . '/images/small-logo.png" class="ws-menu-page-right" style="width:250px; height:77px;" alt="" />' . "\n";
				...
				echo 'Enter Search Terms: <img id="ws-plugin--super-news-loading-animation" src="' . $GLOBALS["WS_PLUGIN__"]["super_news"]["c"]["dir_url"] . '/images/ajax-loader.gif" alt="" />' . "\n";
				echo '</label>' . "\n";
				echo '</th>' . "\n";
				/**/
				echo '</tr>' . "\n";
