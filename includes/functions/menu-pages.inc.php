				...
				if ($_GET["page"] && preg_match ("/ws-plugin--super-news-/", $_GET["page"]))
					{
						...
						/**/
						wp_enqueue_script ("ws-plugin--super-news-menu-pages", get_bloginfo ("wpurl") . "/?ws_plugin__super_news_menu_pages_js=1", array ("jquery", "thickbox", "media-upload", "jquery-json-ps", "jquery-ui-core", "jquery-ui-effects"), $GLOBALS["WS_PLUGIN__"]["super_news"]["o"]["options_version"] . $GLOBALS["WS_PLUGIN__"]["super_news"]["c"]["filemtime"]);
						/**/
