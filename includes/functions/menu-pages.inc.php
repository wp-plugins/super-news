...
if (!function_exists ("ws_plugin__super_news_update_all_options"))
	{
		function ws_plugin__super_news_update_all_options ($new_options = FALSE, $verified = FALSE, $update_other = TRUE, $display_notices = TRUE, $enqueue_notices = FALSE)
			{
				...
				if ($_GET["page"] && preg_match ("/ws-plugin--super-news-/", $_GET["page"]))
					{
						...
						wp_enqueue_script ("json-functions", $GLOBALS["WS_PLUGIN__"]["super_news"]["c"]["dir_url"] . "/includes/menu-pages/json-functions.js", array (), $GLOBALS["WS_PLUGIN__"]["super_news"]["o"]["options_version"] . $GLOBALS["WS_PLUGIN__"]["super_news"]["c"]["filemtime"]);
						...
						/**/
						wp_enqueue_script ("ws-plugin--super-news-menu-pages", get_bloginfo ("wpurl") . "/?ws_plugin__super_news_menu_pages_js=1", array ("jquery", "thickbox", "media-upload", "json-functions", "jquery-ui-core", "jquery-ui-effects"), $GLOBALS["WS_PLUGIN__"]["super_news"]["o"]["options_version"] . $GLOBALS["WS_PLUGIN__"]["super_news"]["c"]["filemtime"]);
						/**/
				...
				if ($_GET["page"] && preg_match ("/ws-plugin--super-news-/", $_GET["page"]))
					{
						...
						wp_enqueue_style ("ws-plugin--super-news-menu-pages", get_bloginfo ("wpurl") . "/?ws_plugin__super_news_menu_pages_css=1", array ("thickbox"), $GLOBALS["WS_PLUGIN__"]["super_news"]["o"]["options_version"] . $GLOBALS["WS_PLUGIN__"]["super_news"]["c"]["filemtime"], "all");
						/**/
