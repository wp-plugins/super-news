...
*/
if (!function_exists ("ws_plugin__super_news_parse_readme"))
	{
		function ws_plugin__super_news_parse_readme ($specific_path = FALSE, $specific_section = FALSE, $_blank_targets = TRUE, $process_wp_syntax = FALSE)
			{
...
*/
if (!function_exists ("_ws_plugin__super_news_parse_readme_specs"))
	{
...
*/
if (!function_exists ("ws_plugin__super_news_parse_readme_value"))
	{
		function ws_plugin__super_news_parse_readme_value ($key = FALSE, $specific_path = FALSE)
			{
