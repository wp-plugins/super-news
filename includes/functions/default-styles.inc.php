		...
		function ws_plugin__super_news_default_styles ()
			{
				...
				if (!is_admin () && $GLOBALS["WS_PLUGIN__"]["super_news"]["o"]["enqueue_styles"])
					{
						wp_enqueue_style ("ws-plugin--super-news", site_url ("/?ws_plugin__super_news_css=1"), array (), $GLOBALS["WS_PLUGIN__"]["super_news"]["o"]["options_version"] . $GLOBALS["WS_PLUGIN__"]["super_news"]["c"]["filemtime"], "all");
						/**/
		...
		function ws_plugin__super_news_search_styles ()
			{
				...
				/**/
				if (ws_plugin__super_news_is_blog_admin () && $_GET["page"] === "ws-plugin--super-news-search")
					{
						wp_enqueue_style ("ws-plugin--super-news", site_url ("/?ws_plugin__super_news_css=1"), array (), $GLOBALS["WS_PLUGIN__"]["super_news"]["o"]["options_version"] . $GLOBALS["WS_PLUGIN__"]["super_news"]["c"]["filemtime"], "all");
						/**/
